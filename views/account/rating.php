...
<?php
	...
	$hikes = array ();
	$hikes = accountController::getMyRates ();
	$title = RATING_TITLE;
...
<ul id="sdt_menu" class="sdt_menu">
	<li>
		<a href="<?php echo URL_DIR.'account/rating';?>"> 
			<img src="/<?php echo SITE_NAME; ?>/Images/myNotes.jpg" alt="" /> 
			<span class="sdt_active"></span> 
			<span class="sdt_wrap"> 
				<span class="sdt_link"><?php echo MENU_MYRATING; ?></span> 
				<span class="sdt_descr"><?php echo MENU_MYNOTES; ?></span>
			</span>
		</a>
		<div class="sdt_box">
...
<div class="content">
	...
	?>
		<div class="hikecontainer"><!-- setting up a default image if none gotten from db -->
			...
			<div class="HikeValue">
				<p>
					<?php
						$starNumber = accountController::getRate ( $hike->getId () );
						for($x = 1; $x <= $starNumber; $x ++) {
							echo '<img src="/' . SITE_NAME . '/Images/star-full.png" alt=""/>' . '  ';
						}
						while ( $x <= 5 ) {
							echo '<img src="/' . SITE_NAME . '/Images/star-empty.png" alt=""/>';
							$x ++;
						}
					?>
				</p>
	...
	<?php 
		endforeach; 
			...
			echo '<h1 class="h1Colored">' . NO_RATING .'</h1>'; 
		endif; 
	?>
</div>
