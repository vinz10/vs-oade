...
<?php
	...
	$hikes = array ();
	$hikes = accountController::getMyRegistration ();
	$title = BOOKING_TITLE;
...
<ul id="sdt_menu" class="sdt_menu">
	<li>
		<a href="<?php echo URL_DIR.'account/booking';?>"> 
			<img src="/<?php echo SITE_NAME; ?>/Images/Hikes.jpg" alt="" /> 
			<span class="sdt_active"></span> 
			<span class="sdt_wrap"> 
				<span class="sdt_link"><?php echo MENU_MYBOOKING; ?></span> 
				<span class="sdt_descr"><?php echo MENU_MYINSCRIPTION; ?></span>
			</span>
		</a>
		<div class="sdt_box">
...
<div class="content">
	...
	<div class="hikeHeader">
		<h1><?php echo MENU_MYINSCRIPTION; ?></h1>
	</div>
	<?php 
		if (!empty($hikes)): 
	...
	?>
		<div class="hikecontainer"><!-- setting up a default image if none gotten from db -->
			...
			<div class="HikeValue">
				<p>
					<?php
						echo NBREHIKERS . ': ' . accountController::getNumberOfPeople ( $hike->getId () ) . '<br/>';
					?>
				</p>
			</div>
		</div>
	<?php 
		endforeach; 
			...
			echo '<h1 class="h1Colored">' . NO_INSCRIPTION .'</h1>'; 
		endif; 
	?>
</div>
